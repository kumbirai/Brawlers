...
- golf-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- golf-ui: main application module, development time
- golf-production: module that produces a production mode WAR for deployment
