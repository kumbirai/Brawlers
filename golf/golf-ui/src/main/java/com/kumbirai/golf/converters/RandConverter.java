package com.kumbirai.golf.converters;
 ...
 * decimal places.
 */
public class RandConverter extends StringToBigDecimalConverter
{
	/**
	 * serialVersionUID
	 */
	...
	public String convertToPresentation(BigDecimal value, Class<? extends String> targetType, Locale locale)
			throws com.vaadin.data.util.converter.Converter.ConversionException
	{
		return "R " + super.convertToPresentation(value, targetType, locale);
	}
}
