...
import com.kumbirai.golf.converters.CollectionToStringConverter;
...
public class ProductGrid extends Grid
{
	...
	{
		@Override
		public String convertToPresentation(Enum availability, java.lang.Class<? extends String> targetType, Locale locale) throws Converter.ConversionException
		{
			...
			String iconCode = "<span class=\"v-icon\" style=\"font-family: " + FontAwesome.CIRCLE.getFontFamily() + ";color:" + color + "\">&#x"
	...
	public ProductGrid()
	{
		...
		getColumn("stockCount").setConverter(new StringToIntegerConverter()
		{
			...
			@Override
			public String convertToPresentation(Integer value, java.lang.Class<? extends String> targetType, Locale locale) throws Converter.ConversionException
			{
				if (value == 0)
				{
					return "-";
		...
		getColumn("price").setConverter(new RandConverter());
		...
		setCellStyleGenerator(new CellStyleGenerator()
		{
			...
			{
				if (cellReference.getPropertyId().equals("price") || cellReference.getPropertyId().equals("stockCount"))
				{
					return "align-right";
				}
				return null;
